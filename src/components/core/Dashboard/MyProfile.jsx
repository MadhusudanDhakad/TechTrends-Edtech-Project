...
export default function MyProfile() {
  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row items-center md:justify-between rounded-md border border-richblack-700 bg-richblack-800 p-4 sm:p-8 md:p-12 gap-4 md:gap-0">
        ...
        <div className="hidden gap-4 md:gap-4 w-full md:w-auto">
         ...
         {/* Profile Image + Name + Email */}
          <div className="flex flex-col sm:flex-row items-center text-center sm:items-center gap-4 md:gap-4 w-full md:w-auto">
            <img
              src={user?.image}
              alt={`profile-${user?.firstName}`}
              className="aspect-square w-20 sm:w-24 md:w-[78px] rounded-full object-cover"
            />
            <div className="flex flex-col sm:gap-1">
              <p className="text-lg sm:text-xl md:text-xl font-semibold text-richblack-5">
                {user?.firstName} {user?.lastName}
              </p>
              <p className="text-sm sm:text-base md:text-base text-richblack-300 break-words">
                {user?.email}
              </p>
            </div>
            {/* Edit Button */}
            <IconBtn
              text="Edit"
              onclick={() => navigate("/dashboard/settings")}
              className="self-start sm:self-center md:self-auto mt-2 md:mt-0"
            >
              <RiEditBoxLine />
            </IconBtn>
          </div>
      ...
      {/* About Section */}
      <div className="my-6 md:my-10 flex flex-col gap-6 md:gap-y-10 rounded-md border border-richblack-700 bg-richblack-800 p-4 sm:p-8 md:p-12">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2 md:gap-0">
          <p className="text-lg md:text-xl font-semibold text-richblack-5">About</p>
      ...
      <div className="my-6 md:my-10 flex flex-col gap-6 md:gap-y-10 rounded-md border border-richblack-700 bg-richblack-800 p-4 sm:p-8 md:p-12">
        ...
        <div className="flex flex-col md:flex-row md:justify-between gap-6 md:gap-12 w-full">
